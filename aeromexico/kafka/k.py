...
# Ejecutar la función principal en streaming
num_vuelos = 2
while True:
    informacion_completa = generar_informacion_completa(num_vuelos)
    print(informacion_completa)
    time.sleep(5)  # Esperar 5 segundos antes de generar nuevos datos